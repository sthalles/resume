...
\usepackage{hyperref}
\usepackage{mdwlist}
\usepackage[top=3.0cm,left=1.8cm,right=1.8cm,bottom=1.0cm]{geometry} %margens
...
\item Top developer in the Internal Machine Learning research group leading an expansion of the Company in this field which allowed for new projects contracts. 
...
\textit{For more projects and a more in-depth view of this CV, please refer to my \textbf{\href{https://www.linkedin.com/in/thalles-silva-32ab08a3/}{Linkedin}} account.}
\end{document}