...
\begin{center}
\begin{tabularx}{1.0\linewidth}{>{\raggedleft\scshape}p{2.2cm}X}
\gray Degree & \textbf{PhD. Candidate in Computer Science} \hfill \textbf{2022 --- Present}\\
\gray University & \textbf{The State University of Campinas} \hfill Campinas, Brazil\\
\gray Advisor & \textbf{Hélio Pedrini, PhD} \hfill University of Campinas\\
\gray Co-advisor & \textbf{Adín Ramírez Rivera, PhD} \hfill University of Oslo\\
\end{tabularx}
\end{center}

\begin{center}
\begin{tabularx}{1.0\linewidth}{>{\raggedleft\scshape}p{2.2cm}X}
\gray Degree & \textbf{Masters in Computer Science} \hfill \textbf{2020 --- 2022}\\
\gray University & \textbf{The State University of Campinas} \hfill Campinas, Brazil\\
\gray Advisor & \textbf{Adín Ramírez Rivera, PhD} \hfill University of Oslo\\
\end{tabularx}
\end{center}
